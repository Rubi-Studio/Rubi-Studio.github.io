export const RANDOM_DATA = {
    names: ["Azhul", "Saphra", "Korun", "Thalindra", "Veyra", "Drakthar", "Zyra", "Eryndor", "Fyrion", "Gorath"],
    origins: ["Hogar en la Montaña Crematoria", "Cuna de Cenizas", "Hogar en el Volcán"],
    flaws: ["Corrupción", "Codicia", "Furia", "Desconfianza", "Impulsividad"],
    settings: ["Torres encantadas, niebla y hechizos protectores.", "Un reino de piedra y runas antiguas."]
};

export const chispasArray = ["Fuego","Escama","Tormenta","Llama","Humo","Rugido","Gema","Encantamiento","Sombras","Eco","Destino","Recuerdo","Tesoro","Secreto","Fragmento","Sueño","Reflejo","Umbral"];
